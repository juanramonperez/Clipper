 ...
 */
function seven_preprocess_node(&$variables){
  //dpm($variables['node']);
  if($variables['node']->type == 'clip'){
    isset($variables['node']->field_theme['und'][0]['entity']->field_machine_name['und'][0]['value']) 
      ? $variables['template'] = $variables['node']->field_theme['und'][0]['entity']->field_machine_name['und'][0]['value']
        : $variables['template'] = 'eclip-01';
  }  
}
