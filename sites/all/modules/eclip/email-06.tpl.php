...
$colores['image_width']       = '452px';
$colores['image_height']      = '';

?>
<p style="text-align: center; font-size:<?php print $colores['bajada_size']; ?>; font-family: <?php print $colores['title_font'] ?>;"><?php print t('Si Ud. no ve este correo correctamente presione <a href="!link">aquí<a>', array('!link' => url('clip/' . $url_prefix . '/' . $node->nid, array('absolute' => TRUE)))); ?></p>
