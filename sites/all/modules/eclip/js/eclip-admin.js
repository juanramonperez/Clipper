            ...
            $('.add-new', context).once('eclip', function () {
                ...
                $this.click(function(e){
                    ...
                    if(!$this.hasClass('added')){
                        var markup = '<div class="news-item new-' + $this.data('nid') + ' status-1 vote-1">'
                            ...
                            + '</span><span class="news-actions"><span class="ui-icon ui-vote"></span><a href="' + Drupal.settings.basePath + 'adm/news/' + $this.data('nid') + '/view">'
                    ...
                    //console.log($(parent.document).find('.view-content'));
                });
            });
