...
(function ($) {
    Drupal.behaviors.eclip = {
        attach: function(context, settings) {
            ...
            $('.portlet', context).once('eclip', function () {
                $(this).addClass( 'ui-widget ui-widget-content ui-helper-clearfix' )
                .find('.portlet-header')
            ...
            $('.news-content .ui-icon-circle-close', context).once('eclip', function () {
                $(this).click(function() {         
            ...
            $('.news-content .ui-vote', context).once('eclip', function () {
                $(this).click(function() {
                    $(this).parents('.news-item:first').each(function(){
            ...
            $('#edit-save').click(function(){
                ...
                $('div.clipper-placeholder').each(function(){
                    ...
                    zone.find('div.portlet').each(function(key, value){
                        ...
                        clip.categories.push([parseInt(zoneId), parseInt(categoryId), key]); 
                        category.find('div.news-item').each(function(key, value){
                            noticia   = $(this);
                            noticiaId = getId('new', noticia.attr('class'));
                            noticia.hasClass('status-0') ? status = 0 : status = 1;
                            clip.news.push([parseInt(categoryId), parseInt(noticiaId), key, status]);           
                        });
                    });          
                });
