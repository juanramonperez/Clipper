...
(function ($){
    Drupal.behaviors.eclip = {
        attach: function(context, settings) {
            $('.view-front-get-news .view-content').once('view-more', function(key, category){
                var totalHeight = 0;
                        ...
                        $(category).parent()
                            ...
                            .find('.vermas').click(function(e){
                                ...
                                if($(this).hasClass('collapsed')){
                                    ...
                                    $(this).parent().find('.view-content').css('height', 'auto');
                                }else{
                                    $(this).html('[Ver más]');
                                    $(this).addClass('collapsed').removeClass('expanded');
                                    $(this).parent().find('.view-content').css('height', $(this).parent().find('.view-content').attr('max'));
                                }
                        });
                    }
